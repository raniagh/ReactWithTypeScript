...
/**
 * GraphQL queries are specified in the request body in an object structure with a query property containing the GraphQL query string,
 * which is GET_VIEWER_QUERY in our case
